  ...
  return (
    <>
      ...
      <div id="productDiary" className="carousel slide" data-bs-ride="carousel">
        ...
        {/* Carousel Controls */}
        <button className="carousel-control-prev" type="button" data-bs-target="#productDiary" data-bs-slide="prev"
        style={{ filter: "invert(1)" }}
        >
          <span className="carousel-control-prev-icon"></span>
        </button>
        <button className="carousel-control-next" type="button" data-bs-target="#productDiary" data-bs-slide="next"
        style={{ filter: "invert(1)" }}
        >
